...
SELECT Gender, COUNT(*) as "Total Passengers" 
FROM PASSENGER 
where Distance>=600 
group by gender;

#4) Find the minimum ticket price for Sleeper Bus. 
SELECT min(price) as 'Minimum Sleeper Price' 
from PRICE 
...
SELECT Passenger_Name, Boarding_City, Destination_City, Price.Bus_Type, Price 
...
delimiter &&
create procedure prod_category()
begin
